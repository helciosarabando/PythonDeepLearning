...
This will be called "LSTM - model 0 - Toy Example"
...
t_select.add_row(['LSTM - 0 "Toy Example"', 'Layers: 1 LSTM + 1 Dropout and 1 Dense'])
print(t_select)
...
#________________________Model 0 - LSTM______________________________________
